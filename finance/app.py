...
def buy():
    ...
    if request.method == "POST":
        ...
        if balance > userRequest:
            ...
            db.execute("INSERT INTO purchases(userID, stock, price, shares, orderTotal, time) VALUES(?, ?, ?, ?, ?, CURRENT_TIMESTAMP)", session["user_id"], stock["symbol"], price, shares, userRequest)
